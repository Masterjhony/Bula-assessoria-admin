...
export async function GET(req: NextRequest) {
  ...
  let q = admin()
    ...
    .select('*, conta:erp_contas_bancarias!conta_bancaria_id(id,nome,cor), categoria:erp_categorias!categoria_id(id,nome,cor), pessoa:erp_pessoas!pessoa_id(id,nome)')
