...
import { dark, typo, space } from '../_lib/tokens'
import { provaSocial as copy } from '../_lib/copy'
...
export function ProvaSocial() {
  return (
    // Esta seção corria com padding próprio, MENOR que o das outras (56/96
    // contra 80/144). Era a tile mais apertada da página inteira sem haver
    // razão para isso — a faixa de logos precisa de ar em volta para ler como
    // prova, não como rodapé. Sobe para perto do padrão.
    <Section surface="dark" style={{ paddingTop: 'clamp(72px, 10vw, 120px)', paddingBottom: 'clamp(72px, 10vw, 120px)' }}>
      <Container wide>
        <Reveal>
          ...
          {/* Claim QUALITATIVO, de propósito. A /touros usa aqui um número
              ("+1.000 touros PO apartados") que está marcado [VALIDAR] no
              copy.ts dela desde antes e nunca foi confirmado pelo cliente.
              Número não validado em página de tráfego pago é risco à toa —
              a prova aqui é a faixa de logos, que é verificável. */}
          <p
      ...
      <Reveal delay={0.06}>
        <div
          ...
          style={{ ['--logo-h' as string]: 'clamp(34px, 4.5vw, 46px)', marginTop: space.xl }}
        >
          <style>{`
