  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderRadius: 18,
        // O card é o menor recipiente de texto da página; se ele aperta, a
        // página inteira parece apertada — são 4 deles seguidos no SubHero.
    ...
    >
      ...
      {title && (
        <h3 style={{ fontFamily: font.display, fontWeight: 600, fontSize: 19, letterSpacing: '-0.01em', color: p.text, marginTop: space.sm }}>
          {title}
        </h3>
      )}
      <p
        style={{
          ...
          marginTop: title ? space.xs : space.sm,
        }}
      >
        {text}
      </p>
