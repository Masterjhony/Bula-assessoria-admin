// ─────────────────────────────────────────────────────────────────────────
// Google Tag Manager — mesmo container das demais landings (decisão do cliente
// em 27/07: um container só para todos os funis).
//
// Escopo: montado APENAS nas rotas deste funil (a landing /femeas e as páginas
// /obrigado-femeas-*). NÃO carrega no painel admin, ERP ou JMP — por isso vive
// aqui e é incluído ponto-a-ponto, não no root layout.
//
// Cópia deliberada do componente de /touros, não import compartilhado: cada
// funil tem que poder trocar de container sem arrastar os outros.
//
