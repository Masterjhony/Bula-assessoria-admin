// ─────────────────────────────────────────────────────────────────────────
// Design tokens — landing do perpétuo de fêmeas. Linguagem
// EDITORIAL-CINEMATOGRÁFICA (Ferrari × Bula).
//
// Cópia literal dos tokens de /touros: a marca é a mesma, e divergir aqui faria
// as duas landings da Bula parecerem de empresas diferentes. Se um token mudar,
// tem que mudar nos dois — não há fonte compartilhada de propósito, para que
// um funil não quebre o outro num deploy.
//
