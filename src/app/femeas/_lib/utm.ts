...
//
// Landing do perpétuo de FÊMEAS. Ver STORAGE_KEY abaixo: a chave é própria.
...
// Chave PRÓPRIA deste funil. Não reaproveitar a de outra landing: os dois
// perpétuos (touros e fêmeas) rodam ao mesmo tempo, e uma chave compartilhada
// deixaria a UTM do último funil visitado sobrescrever a do outro na mesma
// sessão — o lead chegaria ao CRM com a campanha errada.
//
// Isto já falhou uma vez: /saogeraldo foi forkado de /touros e ficou com
// 'touros_utm' (src/app/saogeraldo/_lib/utm.ts:29). Não repetir.
const STORAGE_KEY = 'femeas_utm'
