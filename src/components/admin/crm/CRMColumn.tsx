...
export function CRMColumn({ id, title, leads, onLeadClick, onAddLead, onRename, onCadastroApprovalChange }: CRMColumnProps) {
    ...
    const columnColors: Record<string, string> = {
        ...
        'CONEXÃO': 'bg-red-500/10 text-red-500 border-red-500/20',
        'QUALIFICAÇÃO': 'bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 border-yellow-500/20',
        'INFORMAÇÕES CAPTADAS': 'bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/20',
        'CADASTRO': 'bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/20',
        'PERDIDOS': 'bg-gray-500/10 text-gray-500 border-gray-500/20',
