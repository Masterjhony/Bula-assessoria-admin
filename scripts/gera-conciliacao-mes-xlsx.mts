...
const JULHO: Config = {
  ...
  explica: {
    ...
    'bef2a3a3': { oque: 'Assinatura do Codex / ChatGPT (OpenAI), paga pela Fórmula do Boi e reembolsada. O extrato não trazia memo nenhum; natureza confirmada pelo João em 02/09. Mesma família da Anthropic/Claude (550,00 em 24/08), do plano de banco de dados (180,00 em 18/08) e da Vercel (110,00 em 28/08). ⭐ Estava dentro do lançamento AGREGADO.', ref: 'Sistemas' },
  ...
  leitura: {
    ...
    'Servicos de Terceiros': 'Contador e o reembolso à Fórmula do Boi dos gastos no cartão do desenvolvimento do sistema.',
    ...
    'Software/Assinaturas': 'Hospedagem do site bulaassessoria.com (ClickWeb) e a assinatura do Codex/ChatGPT, reembolsada via Fórmula do Boi.',
  ...
  resumoFim: [
    ...
    { titulo: 'O SEGUNDO TAMPÃO TAMBÉM CAIU (extrato do mês inteiro, 02/09 14:23)', itens: [
      ...
      ['31/07 · Codex/ChatGPT · 525,00', 'confirmado', 'PIX à Fórmula do Boi sem memo nenhum no extrato. O João confirmou em 02/09: assinatura da OpenAI, paga por lá e reembolsada. Virou Software/Assinaturas, junto com a Anthropic, a Vercel e o banco de dados.'],
      ['Julho fechado', '74 de 74', 'O ERP tem exatamente as 74 linhas do extrato, todas conciliadas, com contraparte e título. Saldo 73.259,33 em 30/06 → 25.208,83 em 31/07, ao centavo, e sem nenhum valor calculado no meio. Nenhum lançamento de julho depende de confirmação.', true],
    ] },
  ],
  pendencias: [
