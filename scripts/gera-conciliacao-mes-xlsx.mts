...
const JULHO: Config = {
  ...
  explica: {
    ...
    '5cddf57e': { oque: '2ª das 3 parcelas do Kito (acordo 4R), por liquidação de boleto. ⭐ A data estava em 30/07 como PROVÁVEL, deduzida do fechamento; o extrato do mês inteiro confirmou 31/07 — e mostrou que não houve movimento nenhum em 30/07.', ref: 'Kito — acordo 4R' },
    'aca75439': { oque: 'Passagem de volta do Bula (Goiânia → Campo Grande) para o Leilão LS de 7 e 8/08 — ADN Viagens. ⭐ Estava dentro do lançamento AGREGADO de 30-31/07.', ref: 'LS Galeria 07-08/08' },
    'ba34c509': { oque: 'Passagem de volta do Peralta e da Nane (Goiânia → Campo Grande) para o Leilão LS de 7 e 8/08 — ADN Viagens. ⭐ Estava dentro do lançamento AGREGADO de 30-31/07.', ref: 'LS Galeria 07-08/08' },
    'edfa66f6': { oque: 'Passagem de ida do Peralta, do Bula e da Nane (Cuiabá → Goiânia) para o Leilão LS de 7 e 8/08 — ADN Viagens. ⭐ Estava dentro do lançamento AGREGADO de 30-31/07.', ref: 'LS Galeria 07-08/08' },
    'bef2a3a3': { oque: 'PIX à Fórmula do Boi SEM MEMO NENHUM no extrato. Classificado como o outro PIX do mês ao mesmo CNPJ (444,65 em 07/07, "reembolso de gastos no cartão — desenvolvimento do sistema"). CONFIRMAR: pode ser custo de leilão, como o de 1.648,57 de 10/08. ⭐ Estava dentro do lançamento AGREGADO.' },
    '3a9cfa2b': { oque: 'Tarifa do Sicoob pela liquidação do boleto do Kito (entrada de 15.030,00 no mesmo dia). ⭐ Estava dentro do lançamento AGREGADO.' },
  },
  agregados: [
  ...
  leitura: {
    ...
    'Viagem/Passagens': 'Passagens da Expogenética (Leonardo e Marcelo) e as quatro do Leilão LS de 7 e 8/08 — três delas estavam escondidas no lançamento agregado de 31/07.',
    ...
    'Servicos de Terceiros': 'Contador e dois reembolsos à Fórmula do Boi (gastos no cartão do desenvolvimento do sistema).',
    ...
    'Supermercado/Alimentos': 'Pão & Tal Conveniências.',
  ...
  resumoTopo: [
    { titulo: 'O QUE JULHO ESCONDIA', itens: [
      ...
      ['Situação agora', 'nenhum', 'Os DOIS foram substituídos pelos lançamentos reais, cada um somando o mesmo valor do tampão ao centavo. Julho tem agora as 74 linhas do extrato, nem uma a mais nem a menos, e o ERP inteiro não tem mais nenhum lançamento agregado — todo movimento de 2026 é uma linha real de extrato.', true],
    ] },
  ...
  resumoFim: [
    ...
    { titulo: 'O SEGUNDO TAMPÃO TAMBÉM CAIU (extrato do mês inteiro, 02/09 14:23)', itens: [
      ['31/07 · três passagens · 6.144,98', 'ADN Viagens', 'Leilão LS de 7 e 8/08: volta do Bula, volta do Peralta e da Nane, e a ida dos três de Cuiabá a Goiânia. Somam 6.144,98 e estavam invisíveis dentro do líquido.'],
      ['31/07 · Kito (2/3) · 15.030,00', 'data corrigida', 'Estava lançado em 30/07 como PROVÁVEL, deduzido do fechamento de julho. O extrato confirma 31/07 — e mostra que NÃO HOUVE MOVIMENTO NENHUM em 30/07. A tarifa de 2,08 do mesmo boleto entrou junto.'],
      ['31/07 · Fórmula do Boi · 525,00', 'a confirmar', 'PIX sem memo nenhum no extrato. Classificado como o outro do mês ao mesmo CNPJ (444,65 em 07/07, reembolso de cartão) — é o único lançamento de julho que ainda depende de você.'],
      ['Julho fechado', '74 de 74', 'O ERP tem exatamente as 74 linhas do extrato. Saldo 73.259,33 em 30/06 → 25.208,83 em 31/07, ao centavo, e sem nenhum valor calculado no meio.', true],
    ] },
  ],
  pendencias: [
    ['Fórmula do Boi — 525,00 sem memo',
     'PIX de 31/07 ao CNPJ 65.565.807/0001-17 sem descrição nenhuma no extrato. Está classificado como Serviços de Terceiros por analogia com o outro PIX do mês ao mesmo CNPJ (444,65 em 07/07, "reembolso de gastos no cartão — desenvolvimento do sistema"), mas pode ser custo direto de leilão, como o de 1.648,57 de 10/08. É o único lançamento de julho que ainda depende de confirmação.',
     525, 'Confirmar a natureza com o chefe'],
