...
const PONTE = {
    ...
    'Thyago Tabulero': {
        ficha: null, veredito: 'sem ficha', agrisk: null,
        nota: 'Nenhuma mensagem dos dois grupos cita o nome, o CPF (008.870.602-85), o telefone ou o e-mail dele — nem em agosto, nem depois; e todos os anexos da janela foram abertos um a um. No AgRisk o CPF não existe, nem "Tabulero", "Tabuleiro" ou algum dos dez "Thiago" da base. Não há consulta NESTE CPF — resta a hipótese de ele ter sido consultado sob outro documento (cônjuge, sócio, CNPJ), como aconteceu com o Ademir/Lucas em 30/08.',
    },
