...
const { classifica, canon, cat, fornecedor, dataRef, mesDe, up, n, r2 } =
    criaClassificador({ CATS, CLI, PRE })
/* ------------------------------------------------------------- agregacao  */
...
/* ------------------------------------------------------------- gravacao   */
const arquivo = await gravaXLSX(wb, path.join(os.homedir(), 'Desktop', 'DRE BULA ASSESSORIA 2026 - base HastaPro.xlsx'))
